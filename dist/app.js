...
var swagger_default = {
  ...
  info: {
    ...
    description: "Esta API tem como objetivo facilitar o controle de suas tarefas di\xE1rias",
    termsOfService: "http://localhost:3333/terms",
    contact: {
      email: "orudineylimes@gmail.com"
    }
  },
  servers: [
    {
  ...
  tags: [
    {
      ...
      description: "Rotas de autentica\xE7\xE3o de usu\xE1rios"
    },
    {
      name: "Usu\xE1rio",
      description: "Rotas relacionadas ao gerenciamento de usu\xE1rios"
    },
    {
      name: "Tarefas",
      description: "Rotas relacionadas ao gerenciamento de tarefas"
    }
  ],
  paths: {
    "/v1/session": {
      post: {
        ...
        description: "Autenticar usu\xE1rio",
        requestBody: {
          description: "Dados necess\xE1rios para autentica\xE7\xE3o",
          content: {
            "application/json": {
              schema: {
        ...
        responses: {
          "200": {
            description: "Autentica\xE7\xE3o bem-sucedida",
            content: {
              "application/json": {
                schema: {
    ...
    "/user/v1/create": {
      post: {
        tags: ["Usu\xE1rio"],
        description: "Criar usu\xE1rio",
        requestBody: {
          description: "Dados necess\xE1rios para a cria\xE7\xE3o de um novo usu\xE1rio",
          content: {
            "application/json": {
              schema: {
    ...
    "/user/v1/me": {
      get: {
        tags: ["Usu\xE1rio"],
        security: [{ bearerAuth: [] }],
        description: "Buscar dados do usu\xE1rio autenticado",
        responses: {
          "200": {
          ...
          "401": {
            description: "Usu\xE1rio n\xE3o autenticado",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse"
    ...
    "/user/v1/remove": {
      delete: {
        tags: ["Usu\xE1rio"],
        security: [{ bearerAuth: [] }],
        description: "Deletar usu\xE1rio",
        parameters: [
          {
            name: "user_id",
            in: "query",
            ...
            description: "ID do usu\xE1rio a ser deletado"
          }
        ],
        responses: {
          "200": {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    message: {
                      type: "string",
                      example: "Usu\xE1rio deletado com sucesso"
                    }
                  }
                }
              }
    ...
    "/task/v1/create": {
      post: {
        ...
        requestBody: {
          description: "Dados necess\xE1rios para a cria\xE7\xE3o de uma nova tarefa",
          content: {
            "application/json": {
              schema: {
    ...
    "/task/v1/editTask": {
      put: {
        ...
        requestBody: {
          description: "Dados necess\xE1rios para a edi\xE7\xE3o de uma tarefa",
          content: {
            "application/json": {
              schema: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ResponseEditTask"
                }
              }
            }
          },
        ...
        parameters: [
          {
            ...
            description: "ID do usu\xE1rio para listar tarefas"
          }
        ],
        responses: {
          "200": {
        ...
        parameters: [
          {
            ...
            description: "ID do usu\xE1rio para deletar a tarefa"
          }
        ],
        responses: {
          "200": {
