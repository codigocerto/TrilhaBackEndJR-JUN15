...
var auth_user_routes_exports = {};
__export(auth_user_routes_exports, {
  default: () => auth_user_routes_default
});
module.exports = __toCommonJS(auth_user_routes_exports);
...
// src/routes/user.routes/auth.user.routes.ts
var auth = (0, import_express.Router)();
